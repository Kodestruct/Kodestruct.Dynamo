...
/// 
    ...
    {
        /// <summary>
        ///     Torsional and flexural torsional buckling strength (kip - in unit system for all inputs and outputs)
        /// </summary>
        ...
        /// <param name="IsEccentricallyBraced"> Indicates whether compression member is braced at the centroid or the flange (applies to I-shapes only) </param>
        ...
        public static Dictionary<string, object> TorsionalAndFlexuralTorsionalBucklingStrength(CustomProfile Shape,double L_ex,double L_ey,double L_ez,double F_y,double E=29000.0, bool IsEccentricallyBraced=false, bool IsRolledMember=true,
            string Code = "AISC360-10")
        {
            ...
            SteelLimitStateValue FlexuralTorsionalBuckling = compMember.GetTorsionalAndFlexuralTorsionalBucklingStrength(IsEccentricallyBraced);
