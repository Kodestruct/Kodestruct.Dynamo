...
/// 
    ...
    {
        /// <summary>
        ///     Flexural  flange local buckling (kip - in unit system for all inputs and outputs)
        /// </summary>
        ...
        public static Dictionary<string, object> FlexuralFlangeLocalBuckling(CustomProfile Shape, double F_y, string BendingAxis="XAxis", string FlexuralCompressionLocation="Top",
