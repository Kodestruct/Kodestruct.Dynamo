...
using Kodestruct.Dynamo.UI.Views.Loads.ASCE7_10;
...
namespace Loads.ASCE7_10.Gravity.Snow
{
    ...
    [NodeCategory("Kodestruct.Loads.ASCE7_10.Gravity.Snow")]
    ...
    public class SnowThermalCase : UiNodeBase
    {
        ...
        {
            Uri uri = new Uri("pack://application:,,,/Kodestruct.Dynamo.UI;component/Views/Loads/ASCE7_10/Snow/SnowThermalCase/SnowThermalCaseTreeData.xml");
